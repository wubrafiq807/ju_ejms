...
import com.nazdaq.ja.dao.CommonDao;
...
public class CommonServiceImpl implements CommonService {
	...
	public void saveDepartment(Department theDepartment) {
		commonDao.saveDeparment(theDepartment);	
	}
	...
	public void deleteDepartment(int theId) {
		commonDao.deleteDepartment(theId);
	...
	public Department getDepartment(int theId) {
		// TODO Auto-generated method stub
		return commonDao.getDepartment(theId);
	}

	@Override
	public List<District> getDistricts() {
		// TODO Auto-generated method stub
		return commonDao.getDistricts();
	}

	@Override
	public void saveDistrict(District theDistrict) {
		commonDao.saveDistrict(theDistrict);	
	...
	public District getDistrict(int theId) {
		// TODO Auto-generated method stub
		return commonDao.getDistrict(theId);
	}

	@Override
	public void deleteDistrict(int theId) {
		commonDao.deleteDistrict(theId);
		
	}

	@Override
	public void saveThana(Thana theThana) {
		commonDao.saveThana(theThana);	
